...
public class Movie {
    ...
    private List<CastClass> topBilledCast;
    private List<CrewClass> director;
    ...
    public void setTopBilledCast(List<CastClass> topBilledCast) {
    ...
    public void setDirector(List<CrewClass> director) {
